        ...
        st.markdown(
            ...
            <style>
              .strat-grid { display:grid; grid-template-columns: repeat(2, minmax(240px, 1fr)); gap:12px; }
               .strat-card { border:1px solid #e5e7eb; border-radius:14px; padding:12px 14px; box-shadow:0 1px 2px rgba(16,24,40,.06); min-height: 320px; display:flex; flex-direction:column; overflow:auto; }
